...
def rename_columns(survey: pd.DataFrame) -> pd.DataFrame:
    ...
    survey = survey.rename(
        columns={
            ...
            "Promocja w Social Media": "Social Media Prom.",
            "Ux/Ui": "UxUi",
            "Projektowanie graficzne": "Graphic design",
            "Nawiązywanie Relacji z Biznesem": "Est. Business Relat.",
            "Nawiązywanie Relacji z naukowcami": "Est. Scientists Relat.",
            "Pozyskiwanie finansowania": "Obt. Fin.",
            "Współpraca z administracją UEW": "Coop. UEW admin.",
